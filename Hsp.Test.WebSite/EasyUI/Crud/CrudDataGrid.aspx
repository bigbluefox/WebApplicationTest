<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrudDataGrid.aspx.cs" Inherits="Crud_CrudDataGrid" %>
...
<head id="Head1" runat="server">
    ...
    <script src="/Scripts/V1.5.3/plugins/jquery.edatagrid.js"></script>
    
    <%--<script src="/Scripts/V1.5.3/plugins/jeasyui.extensions.datagrid.getColumnInfo.js"></script>--%>   
    <%--<script src="/Scripts/V1.5.3/plugins/jeasyui.extensions.treegrid.tooltip.js"></script>--%>

</head>
<body>

<h2>CRUD DataGrid『SqlLite Db』</h2>
<p>Double click the row to begin editing.</p>

<table id="dg" title="我的用户信息" style="width: 700px; height: 365px;display:inline-block"

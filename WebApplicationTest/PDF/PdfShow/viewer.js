...
var PDFView = {
    ...
    _setScaleUpdatePages: function pdfView_setScaleUpdatePages(
        ...
        if (!noScroll) {
            ...
            if (this.currentPosition && !IGNORE_CURRENT_POSITION_ON_ZOOM) {
                ...
                dest = [
                    null, { name: "XYZ" }, this.currentPosition.left,
    ...
    load: function pdfViewLoad(pdfDocument, scale) {
        ...
        Promise.all([
            firstPagePromise, storePromise, showPreviousViewOnLoadPromise,
            defaultZoomValuePromise
        ...
        var promises = [
            pagesPromise, destinationsPromise,

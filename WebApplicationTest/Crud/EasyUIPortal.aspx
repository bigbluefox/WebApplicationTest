<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EasyUIPortal.aspx.cs" Inherits="WebApplicationTest.Crud.EasyUIPortal" %>
...
<body>
    ...
    <div id="pp" style="width:1440px;position:relative">
    ...
    <script type="text/javascript">
        var panels = [
            { id: 'p1', title: 'Tutorials', height: 200, collapsible: true, href: '/CombGrid.aspx' },
            { id: 'p2', title: 'Clock', href: '/CombGrid.aspx' },
            { id: 'p3', title: 'PropertyGrid', height: 200, collapsible: true, closable: true, href: '/CombGrid.aspx' },
            { id: 'p4', title: 'DataGrid', height: 200, closable: true, href: '/CombGrid.aspx' },
            { id: 'p5', title: 'Searching', href: '/CombGrid.aspx' },
            { id: 'p6', title: 'Graph', href: '/CombGrid.aspx' }
        ];

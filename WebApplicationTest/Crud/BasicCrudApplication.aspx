<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BasicCrudApplication.aspx.cs" Inherits="WebApplicationTest.Crud.BasicCrudApplication" %>
...
<table id="dg" title="我的用户信息" class="easyui-datagrid" style="width: 700px; height: 360px"
       url="/Handler/CrudHandler.ashx?OPERATION=GETUSER"
...
<%--        <th field="FileName" width="50">文件名称</th>
        <th field="FileSize" width="50">文件大小</th>
        <th field="FileExt" width="50">文件扩展名</th>
        <th field="TypeName" width="50">文件类型</th>--%>
    </tr>
    </thead>
</table>
 </form>   

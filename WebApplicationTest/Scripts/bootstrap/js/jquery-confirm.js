...
(function(factory){
    ...
    $.alert = function(options, option2){
        ...
        if(typeof options === 'string'){
            /**
             * 修正，添加默认图标及自动关闭处理，Tli，20200115
             */
            var icons = "", ac = "", title = (option2) ? option2 : false;
            if (option2 && typeof option2 === "string") {
                if (option2 === "info" || option2.indexOf("操作提示") > -1) {
                    title = "操作提示";
                    icons = "glyphicon glyphicon-info-sign";
                }
                if (option2 === "error" || option2.indexOf("失败") > -1 || option2.indexOf("错误") > -1) {
                    title = "操作失败";
                    icons = "glyphicon glyphicon-remove-sign";
                }
                if (option2 === "success" || option2.indexOf("成功") > -1 || options.indexOf("成功") > -1) {
                    ac = "ok|3000";
                    title = "操作成功";
                    icons = "glyphicon glyphicon-ok-sign";
                }
            }

            options = {
                content: options,
                title: (option2) ? title : false,
                autoClose: (option2) ? (ac.length > 0 ? ac : false) : false,
                icon: (option2) ? (icons.length > 0 ? icons : false) : false
            };
        }
